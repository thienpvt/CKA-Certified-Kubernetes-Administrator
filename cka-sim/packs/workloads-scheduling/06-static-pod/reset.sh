...
# reachable node (not just worker-1 — per 04-REVIEW.md WR-09: a candidate who drops the
...
# uses worker-1/node-02 matching /etc/hosts). Ignore unreachable hosts silently.
