#!/bin/bash
# cka-sim/tests/cases/grade_assert_can_i.sh — verifies cka_sim::grade::assert_can_i.
set -uo pipefail
...
# ---------- pass: fixture returns "yes" ----------
export CKA_SIM_TEST_CURRENT="assert_can_i/pass"
cka_sim::grade::assert_can_i get pods -n cka-sim-test --as alice || true
...
# ---------- fail: fixture returns "no" ----------
export CKA_SIM_TEST_CURRENT="assert_can_i/fail"
cka_sim::grade::assert_can_i get pods -n cka-sim-test --as alice || true
