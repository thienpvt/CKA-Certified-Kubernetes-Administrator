#!/bin/bash
# cka-sim/tests/cases/grade_assert_egress_allowed.sh — verifies cka_sim::grade::assert_egress_allowed.
set -uo pipefail
...
# ---------- pass: kubectl exec returns rc=0 ----------
export CKA_SIM_TEST_CURRENT="assert_egress_allowed/pass"
cka_sim::grade::assert_egress_allowed cka-sim-test web 10.0.0.1 80 || true
...
# ---------- fail: kubectl exec returns rc=1 ----------
export CKA_SIM_TEST_CURRENT="assert_egress_allowed/fail"
cka_sim::grade::assert_egress_allowed cka-sim-test web 10.0.0.1 80 || true
