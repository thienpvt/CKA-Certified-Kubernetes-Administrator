#!/bin/bash
# Phase 07.1 grading-honesty regression: services-networking/02-service-core
# Asserts empty submission scores 0/3 (Service is setup-owned with bad selector;
# delta gate + selector mismatch + empty endpoints all fail).
# Ref-solution scores 3/3 after candidate patches selector.
...
export CKA_SIM_LAB_NS="cka-sim-services-networking-02"
