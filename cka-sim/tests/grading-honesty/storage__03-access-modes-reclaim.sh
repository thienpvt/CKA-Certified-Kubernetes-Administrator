#!/bin/bash
# Phase 07.1 grading-honesty regression: storage/03-access-modes-reclaim
# AUDIT-01: replaced leaky `assert_pvc_bound q03-rwo-pvc` (setup binds it
# immediately) with `assert_changed_since_setup pv q03-retain-pv` to gate on
# candidate modification of the PV.
# Asserts empty submission (post-setup state) scores 0/4
...
export CKA_SIM_LAB_NS="cka-sim-storage-03"
