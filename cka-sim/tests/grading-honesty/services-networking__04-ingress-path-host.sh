#!/bin/bash
# Phase 07.1 grading-honesty regression: services-networking/04-ingress-path-host
# Asserts empty submission scores 0/5 (Ingress is candidate-authored from scratch;
# setup creates only Service + IngressClass).
# Ref-solution scores 5/5 after candidate authors Ingress.
...
export CKA_SIM_LAB_NS="cka-sim-services-networking-04"
