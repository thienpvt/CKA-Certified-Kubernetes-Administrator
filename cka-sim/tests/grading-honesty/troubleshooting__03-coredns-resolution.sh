#!/bin/bash
# Phase 07.1 grading-honesty regression: troubleshooting/03-coredns-resolution
# Asserts empty submission (post-setup state) scores 0/4 (CM+Deploy unchanged + DNS broken)
# AND ref-solution (post-ref-solution state) scores 4/4 (CM+Deploy edited, DNS works).
...
export CKA_SIM_LAB_NS="cka-sim-troubleshooting-03"
