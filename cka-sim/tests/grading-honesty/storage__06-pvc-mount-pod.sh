#!/bin/bash
# Phase 07.1 grading-honesty regression: storage/06-pvc-mount-pod
# AUDIT-01: no leak found (Deployment + exec probe all require candidate Deployment).
...
export CKA_SIM_LAB_NS="cka-sim-storage-06"
